                ...
                <tbody>
                    <c:forEach items="${emp}" var="e">
                        <tr>
                            ...
                            <td>${e.fee}</td>
                            <td>
                                <a href="updateD?id=${e.id}&name=${e.name}&contact=${e.contact}&experience=${e.experience}&degree=${e.degree}&speciality=${e.speciality}&fee=${e.fee}" class="btn btn-sm btn-warning">Edit</a>
                                <a href="delete-form?id=${e.id}" class="btn btn-sm btn-danger">Delete</a>
                            </td>
                        </tr>
                    </c:forEach>
                </tbody>
