...
<!-- Mirrored from themewagon.github.io/medicalcenter/doctor.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 03 Jun 2024 15:48:50 GMT -->
...
<head>
   ...
   <style>
    ...
    .form-control {
      font-size: 1.25rem; /* Increase the font size for inputs */
      padding: 0.75rem 1.25rem; /* Increase the padding for inputs */
      height: 5vh;
                            ...
                            <div class="main-menu f-right d-none d-lg-block">
                                <nav>
                                    <ul id="navigation">
                                        ...
                                        <li><a href="hdoctor">Petient</a></li>
                                        <li><a href="Hdepartment">Department</a></li>
                                        <li><a href="Hblog">Blog</a></li>
                                        <li><a href="HDoctorCntact">Contact</a></li>
                                    </ul>
                                </nav>
                            </div>
                ...
                <div class="col-lg-12">
                    <div class="depart_ment_tab mb-30">
                        ...
                        <ul class="nav" id="myTab" role="tablist">
                            <li class="nav-item">
                                <a class=" add btn active" id="home-tab" data-toggle="tab" href="#home" role="tab" aria-controls="home" aria-selected="true">
                                    
                                    Doctor Register
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class=" add btn" id="profile-tab" data-toggle="tab" href="#profile" role="tab" aria-controls="profile" aria-selected="false">
                                   
                                    Search Doctor
                                </a>
                            </li>
                            
                             <button type="button"  class="btn btn-primary btn-custom" style="margin-left: 200px"><a href="select-all">Doctor List</a></button>
            ...
            <form action="dadd">
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control" name="id" placeholder="Enter Doctor ID">
                    </div>
                    <div class="form-group col-md-6">
                ...
                <div class="form-row">
                    ...
                    <button type="button" class="btn btn-secondary btn-custom mr-2" onclick="history.back()">Back</button>
                    <button type="button" class="btn btn-info btn-custom" onclick="window.location.href='home'">Home</button>
                </div>
            </form>
        </div>
    </div>
                    ...
                    <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                        ...
                        <div class="row align-items-center no-gutters">
                            <div class="col-lg-12">
                              <div class="container">
        <div class="form-container">
            <h1 class="mb-4 text-center">Search Id </h1>
