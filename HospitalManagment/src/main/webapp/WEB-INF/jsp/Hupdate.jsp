      ...
      <form action="hupdate">
        ...
        <div class="form-row">
          ...
          <div class="form-group col-md-6">
            ...
            <input type="text" class="form-control" name="experience"  value="<%=request.getParameter("experience")%>" >
          </div>
        </div>
        <div class="form-row">
          <div class="form-group col-md-6">
            <label for="degree">Degree</label>
            <input type="text" class="form-control" name="degree"  value="<%=request.getParameter("degree")%>" >
          </div>
          <div class="form-group col-md-6">
            <label for="speciality">Speciality</label>
            <input type="text" class="form-control" name="speciality" value="<%=request.getParameter("speciality")%>" >
          </div>
        </div>
        <div class="form-row">
          <div class="form-group col-md-6">
            <label for="fee">Fee</label>
            <input type="text" class="form-control" name="fee" value="<%=request.getParameter("fee")%>"  >
          </div>
        </div>
        <div class="form-row">
